...
public class StringUtils {
    ...
    /**
     * Originally from RoboGuice: https://github.com/roboguice/roboguice/blob/master/roboguice/src/main/java/roboguice/util/StringUtils.java
    ...
    public static <T> String joinAnd( final String delimiter, final String lastDelimiter, final Collection<T> objs ) {
        ...
        while (iter.hasNext()) {
            ...
            if(notEmpty(obj)) buffer.append( ++i == objs.size() ? lastDelimiter : delimiter).append(StringUtils.toString(obj));
        }
